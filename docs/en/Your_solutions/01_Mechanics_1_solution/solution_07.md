...
1. **Eliminate parameter $t$:**
   ...
   Substitute into $y$: $y = 3\left(\sqrt{\frac{x}{2}}\right)^3 = 3\left(\frac{x}{2}\right)^{3/2} = \frac{3}
   {2\sqrt{2}}x^{3/2}$.

2. **Trajectory curve:** It is a curve starting from the origin in the first quadrant, growing steeper as 
$x$ increases. Let's write it as $y^2 = \frac{9}{8}x^3$ (a semicubical parabola).
