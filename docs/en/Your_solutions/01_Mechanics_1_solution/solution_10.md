...
1. **Equation of trajectory (a):**
   ...
   The projection onto the $xy$-plane is an ellipse. Since $z = bt$, $z$ grows linearly with time. The 
   trajectory is an **elliptical helix** winding around the $z$-axis.
...
[Open the demo](animations/01_10_anim.html)